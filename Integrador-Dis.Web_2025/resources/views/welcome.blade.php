...
<head>
    ...
    <title>Bienvenido - Instituto XXX</title>
...
<body class="min-h-screen bg-gradient-to-br from-purple-100 to-purple-300 p-4 flex flex-col min-h-screen">
    ...
    <main class="max-w-6xl mx-auto bg-white p-8 rounded-xl shadow-2xl text-center">
        ...
        <section class="bg-purple-50 p-6 rounded-lg shadow-inner border border-purple-200 mt-8">
            ...
            <button class="bg-purple-600 text-white py-3 px-8 rounded-lg font-semibold text-lg hover:bg-purple-700 transition duration-300 ease-in-out transform hover:scale-105 shadow-md">Ver Nuestros Cursos</button>
        </section>
    </main>
</body>
</html>